      ...
      {isOpen && (
        <>
          ...
          <motion.aside
            ...
            className="fixed right-0 top-0 h-full w-full sm:w-[420px] bg-white dark:bg-zinc-950 border-l border-zinc-200 dark:border-white/[0.08] shadow-2xl z-[100] flex flex-col"
          >
            {/* Sidebar Header */}
            <header className="p-4 border-b border-zinc-250/60 dark:border-white/[0.08] flex items-center justify-between bg-zinc-50 dark:bg-zinc-900/30">
              ...
              <Button
                ...
                variant="ghost"
                size="sm"
                className="h-8 w-8 p-0 flex items-center justify-center rounded-lg text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300 transition-colors"
            ...
            {selectedProfiles.length > 0 && (
              <div className="px-4 pt-4 pb-1 border-b border-zinc-100 dark:border-white/[0.03]">
                <div className="relative w-full">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-8 py-2 bg-zinc-50 dark:bg-zinc-900 border border-zinc-250 dark:border-white/[0.06] rounded-xl text-xs text-zinc-900 dark:text-zinc-100 placeholder-zinc-450 focus:outline-none focus:border-purple-500 focus:ring-3 focus:ring-purple-500/10 transition-all"
                  />
                  {drawerQuery && (
                    <button
                    ...
                    return (
                      ...
                      >
                        ...
                        <Button
                          ...
                          variant="ghost"
                          size="sm"
                          className="p-1.5 h-8 w-8 rounded-lg text-zinc-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-950/20 transition-all flex-shrink-0"
            ...
            {/* Sidebar Footer with reach statistics */}
            {selectedProfiles.length > 0 && (
              <footer className="p-4 border-t border-zinc-250/60 dark:border-white/[0.08] bg-zinc-50/50 dark:bg-zinc-900/20 space-y-3">
